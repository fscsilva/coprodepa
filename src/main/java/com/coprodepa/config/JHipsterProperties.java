...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "coprodepa@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "coprodepa API";

        private String description = "coprodepa API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "coprodepa";
